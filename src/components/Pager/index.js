...
export default function Pager({current, total, path}) {
      ...
      <ul className="pagination pagination-sm mb-0">
        ...
        <li className="page-item disabled">
          <span className="page-link text-nowrap">
            {t('common.pager.page')} <strong className="font-weight-medium">{current}</strong> {t('common.pager.of')}  <strong className="font-weight-medium">{total || '1'}</strong>{t('common.pager.ye')} 
          </span>
        </li>
