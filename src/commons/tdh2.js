...
function decrypt_SM4(key_TDH2, cipher) {
  ...
  const decmsg = sm4.decrypt(data.SymCtxt, real_key_SM4);
...
export  {decrypt_SM4,encrypt_sm4,decrypt_sm4_2, decrypt_AESGCM, combine_Share, verify_share, encrypt, GenerateKeys, newPoly, ployShare, Combine, tdh2EncryptInner, tdh2Decryption, verifyShare, combineShare, p256,sm3hash,sm3hashStr}
